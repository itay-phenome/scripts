...
export REVISION="14965"
export MYSQL_HOST="production.c2lwxovefzco.eu-west-1.rds.amazonaws.com"
export MYSQL_USER="phenome"
export MYSQL_PASS="XSUVePuFroQVdcvVWwpK"
export BUCKET_REGION="eu-west-1"
export BUCKET_UPLOADS="enza-prod-upload"
export BUCKET_IMAGES="enza-prod-images"
export BUCKET_ANALYSES="enza-prod-analysis"
export BUCKET_REPORTS="enza-prod-images"
export BUCKET_DOCUMENTS="enza-prod-documents"
export SQS="arn:aws:sqs:eu-west-1:307543733114:enza-prod-upload-7540"
